    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link waves-effect" href="#" target="_blank">V-Cards</a>
          </li>
          <li class="nav-item">
            <a class="nav-link waves-effect" href="#" target="_blank">I-Cards</a>
          </li>
          <li class="nav-item">
            <a class="nav-link waves-effect" href="#" target="_blank">Printing</a>
          </li>
        </ul>
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="view overlay">
                <img src="img/demo.jpg" class="card-img-top" alt="">
                <a>
              ...
              <div class="card-body text-center">
                ...
                <h5>
                  <strong>
                    <a href="" class="dark-grey-text">Card Name
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                ...
                <h5>
                  <strong>
                    <a href="" class="dark-grey-text">Card Name</a>
                  </strong>
                </h5>
            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                ...
                <h5>
                  <strong>
                    <a href="" class="dark-grey-text">Card Name
                    <!--  <span class="badge badge-pill primary-color">Card Name</span>-->
                    </a>
                  </strong>
                </h5>
  ...
  <footer class="page-footer text-center font-small mt-4 wow fadeIn">
   ...
   <!--   <a href="https://www.facebook.com/mdbootstrap" target="_blank">
    ...
    <div class="footer-copyright py-3">
      © 2019 Copyright:
      <a href="https://joshienterprises.in" target="_blank">Joshi Enterprises</a>
    </div>
    <!--/.Copyright-->
